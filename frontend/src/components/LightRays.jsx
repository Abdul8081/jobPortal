...
void main() {
  ...
  gl_FragColor  = color;
      ...
      // Mobile-optimized speed and intensity
      const mobileSpeed = isMobile ? raysSpeed * 0.8 : raysSpeed;
      ...
      const debouncedResize = () => {
        ...
        resizeTimeoutRef.current = setTimeout(updatePlacement, 100);
      };
      ...
      const loop = t => {
        ...
        if (followMouse && mouseInfluence > 0.0) {
          const smoothing = isMobile ? 0.85 : 0.92; // Faster response on mobile
  ...
  // Support both mouse and touch events (pointer events)
  useEffect(() => {
